...
This page lists the existing process models within ``QSDsan`` for biological or chemical kinetic simulation, the following table provides the reference and example implementation (``qsdsan.process_models``).
