...
import numpy as np
from ..unit_operations import WWTpump
from ..unit_operations._static_pumping import default_F_BM as default_WWTpump_F_BM
...
class PrimaryClarifierBSM2(SanUnit):
    ...
    >>> from qsdsan.unit_operations import PrimaryClarifierBSM2
...
class PrimaryClarifier(IdealClarifier):
    ...
    >>> set_thermo(cmps_test)
    >>> ws = WasteStream('ws', S_F = 10, S_NH4 = 20, X_OHO = 15, H2O=1000)
    >>> from qsdsan.unit_operations import PrimaryClarifier
