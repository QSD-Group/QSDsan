...
Note: `unit_operations/dynamic/_electrochemical_cell.py` is a separate module
holding `ESAP`/`ESAPRecovery`/`ESAPEffluent`, a modular, dynamic-capable
redesign of the monolithic `ElectrochemicalStrippingAdsorptionPrecipitation`
unit defined here.
'''
...
from ...equipments import Electrode, Membrane
...
class ElectrochemicalCell(SanUnit):
    ...
    References
    ----------
    [1] Simon, J. Evaluating Membrane Performance in Electrochemical Stripping
    Reactor for Nitrogen Removal. M.S. Thesis, Department of Chemical Engineering,
    Stanford University. Principal Investigator: William Tarpeh; Second Reader:
    Gerald Fuller.
    '''
