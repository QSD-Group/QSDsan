...
# Q = 1 MGD = 3785.41 m3/day                        # Shell
Q = 3785.41                                         #!!! increasing Q shouldn't affect process simulation, but it'd increase numerical stability
...
# Medium (Thin Stillage 100%)
default_inf_kwargs = {
    'concentrations': {
        'S_su':0.0,                                             # S_su = 2.3 mM -> 0.414 g COD/L
        'S_aa':0.0,
        'S_fa':0.0,
        'S_la':0.0,                                              # S_la = 4.88 mM -> 0.44 g COD/L
        'S_et':0.0,                                             # S_et = 10.09 mM -> 0.465 g COD/L
        'S_va':0.4596,
        'S_bu':0.0209,                                             # S_bu = 8.33 mM -> 0.726 g COD/L
        'S_pro':0.1023,                                            # S_pro = 4.12 mM -> 0.301 g COD/L
        'S_ac':0.443,                                             # S_ac = 24.98 mM -> 1.475 g COD/L
        'S_h2':1e-8,
        'S_ch4':0.0,
        'S_IC':0.0*C_mw,                                             
        'S_IN':5.553*1e-5*N_mw,                                    #!!! 0.04975 g COD/L, S_IN: 5.553*1e-5 kmole N / m3? * N_mw, why different? Fixed value
