...
data_path += 'sanunit_data/_primaryES.tsv'



class PrimaryES(SanUnit, Decay):
    '''
...
#throughout whole system is considered in TEA 
    ...
    def _cost(self):
        ...
        # #self.purchase_costs['Chemicals'] = (self.MgOH2_cost)
        ...
        # #no operating cost associated 
        
        # #self.power_utility(self.power_demand)
        
        #self.purchase_costs['Tanks'] = (self.tank_s2_cost)
        self._BM = dict.fromkeys(self.purchase_costs.keys(), 1)
