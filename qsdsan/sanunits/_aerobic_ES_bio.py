...
__all__ = ('AerobicESBio',)

data_path += 'sanunit_data/_aerobic_ES_bio.tsv'





class AerobicESBio(SanUnit, Decay):
    '''
...
#Anaerobic is 60-80%     
    def _run(self):
        ...
        N2O.phase = CH4.phase = 'g'
        
     
        #double check if it releases 
        # COD removal 
        ...
        N2O_prcd = N_loss_tot*self.N2O_EF_decay*44/28
        N2O.imass['N2O'] = N2O_prcd #check units
