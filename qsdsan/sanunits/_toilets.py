...
class MURT(Toilet):
    ...
    def __init__(self, ID='', ins=None, outs=(), thermo=None, init_with='WasteStream',
        ...
        #!!! This might be copied from UDDT and should be removed
        self._tank_V = 60 / 1e3  # m3
        self._mixed = WasteStream(f'{self.ID}_mixed')
    ...
    def _design(self):
        ...
        if self.if_include_front_end:
            ...
            design['Parallel toilets'] = N = self.N_toilet
            design['Collection period'] = self.collection_period
            design['Ceramic'] = Ceramic_quant = self.squatting_pan_weight + self.urinal_weight
    ...
    def _cost(self):
        ...
        if self.if_include_front_end:
            ...
            C['Ceramic Toilets'] = (self.squatting_pan_cost + self.urinal_cost) * N_toilet
...
# =============================================================================
# Legacy MURT, not sure where it is used
# =============================================================================
...
#                  N_tot_user=None, if_toilet_paper=True, if_flushing=True, if_cleansing=False,
#                  if_desiccant=False, if_air_emission=True, if_ideal_emptying=True,
#                  CAPEX=0, OPEX_over_CAPEX=0.075, lifetime=25,
