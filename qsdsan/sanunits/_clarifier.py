...
class FlatBottomCircularClarifier(SanUnit):
    ...
    def __init__(self, ID='', ins=None, outs=(), thermo=None,
        ...
        self._design_tss = design_influent_TSS # mg/L
        self._design_flow = design_influent_flow # m3/hr
    ...
    def design_surface_overflow_rate(self, sor):
        self._sor = sor

    @property
    def design_influent_TSS(self):
        '''[float] The design influent TSS concentration in mg/L.'''
        return self._design_tss
    
    @design_influent_TSS.setter
    def design_influent_TSS(self, tss):
        self._design_tss = tss

    @property
    def design_influent_flow(self):
        '''[float] The design influent flow in m3/hr.'''
        return self._design_flow
    
    @design_influent_flow.setter
    def design_influent_flow(self, flow):
