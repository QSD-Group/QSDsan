...
class ED_vfa(SanUnit):
    def __init__(self, ID='', ins=None, outs=None, thermo=None, init_with='WasteStream',
        ...
        self.permselectivity = permselectivity or {'S_pro/S_bu': 1.398166, 'S_pro/S_he': 1.896961, 'S_bu/S_he': 1.353608}  # Default permselectivity
        self.j = j
        self.t = t
        self.A_m = A_m
        self.V_dc = V_dc
...
for A_m in A_m_values:
    ...
    ed = ED_vfa(
        ...
        ce_S_pro=0.1  # Set ce_S_pro to 0.1
    )
