...
def sum_system_utility(system, operating_hours=None, exclude_units=(),
    ...
    if utility in ('power', 'electricity'):
        unit = 'kWh' if not result_unit else result_unit
        ...
        return auom('kWh').convert(tot, unit)
    elif utility == 'heating':
        unit = 'GJ' if not result_unit else result_unit
        ...
        return auom('GJ').convert(tot, unit)
