...
pH, ions, all_precipitates = pH_solver(kw=10**-14, activity=True, check_precipitation = True,
                                       weak_chemicals={'PO4':0.05, 'NH3':0.05, 'acetate':0.05, 'carbonic': 0.05},
                                       other_chemicals={(('Na', 1),): (0.05,), (('Cl', -1),): (0.05,), (('NO3', -1),): (0.05,), (('Mg', 2),): (0.05,), (('Fe3', 3),): (0.05,), (('Ca', 2),): (0.05,)})
