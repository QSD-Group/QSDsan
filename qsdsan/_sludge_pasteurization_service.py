...
__all__ = ('SludgePasteurizationService',)

data_path += 'sanunit_data/_sludge_pasteurization_service.csv'

class SludgePasteurizationService(SanUnit):
    '''
    SLUDGE PASTEURIZATION SERVICE FOR SLUDGE FROM SEPTIC TANK
    Parameters
    ----------
    if_combustion : bool
    ...
    def _calc_replacement_cost(self):
        sludge_replacement_cost =  self.sludge_service #USD/yr
