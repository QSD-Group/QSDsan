...
_mmp = ospath.join(data_path, "C:/Users/Aravi/OneDrive/Desktop/workspace/QSDsan/qsdsan/data/process_data/_mmp.tsv")
...
class ADM1p(ADM1):
    ...
    def __new__(cls, components=None, path=None, 
        ...
        # If Processes.load_from_file accepts a 'data' parameter directly
        mmp = Processes.load_from_file(path=_mmp, components=cmps, conserved_for=(), compile=False)
