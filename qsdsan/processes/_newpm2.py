...
__all__ = ('create_newpm2_cmps', 'NEWPM2')

_path = ospath.join(data_path, 'process_data/_newpm2.tsv')

#%% 
# =============================================================================
# NEWPM2-specific components
# =============================================================================

def create_newpm2_cmps(set_thermo=True):
    ...
    cmps_newpm2 = Components([X_CHL, X_ALG, X_CH, X_LI, S_CO2, S_A, S_F, 
                           S_O2, S_NH, S_NO, S_P, X_N_ALG, X_P_ALG, cmps.H2O])
    
    cmps_newpm2.default_compile()                   

    if set_thermo: settings.set_thermo(cmps_newpm2)
    return cmps_newpm2
...
def rhos_newpm2(state_arr, params):
...
# calculate kinetic rate values
    ...
    rhos[6] = growth_on_carbohydrate(X_ALG, Q_N, Q_P, dark_response, f_I, f_CH, f_LI, temp, mu_max, exponent, Q_N_min, Q_P_min, rho, Y_CH_PHO, Y_LI_PHO, K_STO, arr_a, arr_e)
    ...
    rhos[7] = growth_on_lipid(X_ALG, Q_N, Q_P, dark_response, f_I, f_CH, f_LI, temp, mu_max, exponent, Q_N_min, Q_P_min, rho, Y_CH_PHO, Y_LI_PHO, K_STO, arr_a, arr_e)
...
class NEWPM2(CompiledProcesses):
    '''
    Parameters
    ----------
    ...
    >>> cmps = pc.create_newpm2_cmps()
    >>> newpm2 = pc.NEWPM2()
    >>> newpm2.show()
    NEWPM2([photoadaptation, ammonium_uptake, phosphorus_uptake, growth_pho, 
    ...
    _kinetic_params = ('a_c', 'I_n', 'arr_a', 'arr_e', 'beta_1', 'beta_2', 'b_reactor', 'I_opt', 'k_gamma', 
                       ...
                       'Y_ATP_PHO', 'Y_ATP_HET_ACE', 'Y_ATP_HET_GLU', 'n_dark', *_shared_params, 'cmps')
    ...
    def __new__(cls, components=None,
        ...
        self.set_rate_function(rhos_newpm2)
        ...
        kinetic_values = (a_c, I_n, arr_a, arr_e, beta_1, beta_2, b_reactor, I_opt, k_gamma, 
                          ...
                          Y_CH_PHO, Y_LI_PHO, Y_X_ALG_PHO, 
                          Y_CH_NR_HET_ACE, Y_LI_NR_HET_ACE, Y_X_ALG_HET_ACE, 
                          Y_CH_NR_HET_GLU, Y_LI_NR_HET_GLU, Y_X_ALG_HET_GLU, n_dark, self._components)
