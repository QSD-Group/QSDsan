...
class ADM1_vfa(CompiledProcesses):
    ...
    def __new__(cls, components=None, path=None, N_xc=2.686e-3, N_I=4.286e-3, N_aa=7e-3,
                ...
                f_fa_li=0.01, f_la_su=0.433, f_et_su= 0.004, f_bu_su=0.13,
                f_ac_su=0.02, f_va_aa=0.23, f_bu_aa=0.06, f_pro_aa=0.05, f_ac_aa=0.02,
                f_ac_fa=0.4, f_pro_la=0.33, f_ac_la=0.02, f_ac_et=0.02, f_pro_va=0.54,
                f_ac_va=0.02, f_ac_bu=0.02, f_ac_pro=0.02, f_pro_h2=0.05,
                Y_su=0.1, Y_aa=0.08, Y_fa=0.06, Y_la=0.06, Y_et=0.04, Y_c4=0.06, Y_pro=0.04, Y_ac=0.05, Y_h2=0.06,
                q_dis=0.05, q_ch_hyd=5.0, q_pr_hyd=7.0, q_li_hyd=5.0,
                k_su=30, k_aa=50, k_fa=6, k_la=1.0, k_et=6.41, k_c4=20, k_pro=5.5, k_ac=4.0, k_h2=35,
