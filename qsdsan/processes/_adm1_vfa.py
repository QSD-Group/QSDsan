...
class ADM1_vfa(CompiledProcesses):
    ...
    def __new__(cls, components=None, path=None, N_xc=2.686e-3, N_I=4.286e-3, N_aa=7e-3,
                ...
                f_ac_fa=0.2, f_pro_la=0.2, f_ac_la=0.05, f_ac_et=0.1, f_pro_va=0.64,
                f_ac_va=0.15, f_ac_bu=0.15, f_ac_pro=0.1, f_pro_h2=0.15,
                ...
                k_su=12.0, k_aa=50, k_fa=6, k_la=8.0, k_et=5.0, k_c4=20.6, k_pro=13, k_ac=8.0, k_h2=44,
