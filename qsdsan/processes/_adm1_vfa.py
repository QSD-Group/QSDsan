...
class ADM1_vfa(CompiledProcesses):
    ...
    def __new__(cls, components=None, path=None, N_xc=2.686e-3, N_I=4.286e-3, N_aa=7e-3,
                f_ch_xc=0.2, f_pr_xc=0.2, f_li_xc=0.3, f_xI_xc=0.2,
                f_fa_li=0.95, f_la_su=0.533, f_et_su= 0.1, f_bu_su=0.13,
                f_ac_su=0.41, f_va_aa=0.33, f_bu_aa=0.17, f_pro_aa=0.17, f_ac_aa=0.16,
                ...
                k_su=4.0, k_aa=50, k_fa=10, k_la=8.0, k_et=5.0, k_c4=20.6, k_pro=5.5, k_ac=4.0, k_h2=44,
