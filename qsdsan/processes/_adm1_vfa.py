...
class ADM1_vfa(CompiledProcesses):
    ...
    def __new__(cls, components=None, path=None, N_xc=2.686e-3, N_I=4.286e-3, N_aa=7e-3,
                f_ch_xc=0.2, f_pr_xc=0.2, f_li_xc=0.3, f_xI_xc=0.2,
                f_fa_li=0.95, f_la_su=0.433, f_et_su= 0.05, f_bu_su=0.13,
                f_ac_su=0.15, f_va_aa=0.33, f_bu_aa=0.17, f_pro_aa=0.17, f_ac_aa=0.1,
                f_ac_fa=0.3, f_pro_la=0.3, f_ac_la=0.05, f_ac_et=0.15, f_pro_va=0.64,
                f_ac_va=0.15, f_ac_bu=0.15, f_ac_pro=0.2, f_pro_h2=0.15,
                Y_su=0.1, Y_aa=0.08, Y_fa=0.06, Y_la=0.06, Y_et=0.04, Y_c4=0.06, Y_pro=0.03, Y_ac=0.02, Y_h2=0.07,
                q_dis=0.5, q_ch_hyd=10.0, q_pr_hyd=4.0, q_li_hyd=5.0,
                k_su=12.0, k_aa=50, k_fa=6, k_la=8.0, k_et=5.0, k_c4=20.6, k_pro=13, k_ac=4.0, k_h2=44,
        ...
        #def f_lac_su_eval
        dct['_dyn_params'] = dict.fromkeys(('f_la_su', 'f_ac_pro_la', 'f_ac_la', 'f_pro_la', 'f_pro_h2')) #!!! added f_pro_la
        # <<<<<<<<<<<<
        ...
        dct['_parameters']['f_ac_pro_la'] = 0.57 #!!! non changed values in dct
