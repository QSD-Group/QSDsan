...
class ADM1_vfa(CompiledProcesses):
    ...
    def __new__(cls, components=None, path=None, N_xc=2.686e-3, N_I=4.286e-3, N_aa=7e-3,
                ...
                f_ac_su=0.2, f_va_aa=0.33, f_bu_aa=0.17, f_pro_aa=0.17, f_ac_aa=0.1,
                f_ac_fa=0.5, f_pro_la=0.3, f_ac_la=0.05, f_ac_et=0.2, f_pro_va=0.64,
                f_ac_va=0.2, f_ac_bu=0.2, f_ac_pro=0.3, f_pro_h2=0.15,
