...
class ADM1_vfa(CompiledProcesses):
    ...
    def __new__(cls, components=None, path=None, N_xc=2.686e-3, N_I=4.286e-3, N_aa=7e-3,
                ...
                f_ac_su=0.42, f_va_aa=0.33, f_bu_aa=0.17, f_pro_aa=0.17, f_ac_aa=0.16,
                f_ac_fa=0.72, f_pro_la=0.45, f_ac_la=0.07, f_ac_et=0.3, f_pro_va=0.64,
                ...
                k_su=8.0, k_aa=50, k_fa=6, k_la=8.0, k_et=5.0, k_c4=20.6, k_pro=13, k_ac=4.0, k_h2=44,
