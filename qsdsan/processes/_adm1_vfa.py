...
class ADM1_vfa(CompiledProcesses):
    ...
    #f_la_su, f_et_su, f_pro_la, f_ac_la,  f_ac_et, Y_la, Y_et added with valued randomly below
    def __new__(cls, components=None, path=None, N_xc=2.686e-3, N_I=4.286e-3, N_aa=7e-3,
                f_ch_xc=0.19, f_pr_xc=0.15, f_li_xc=0.11, f_xI_xc=0.5,
                f_fa_li=0.01, f_la_su=0.433, f_et_su= 0.05, f_bu_su=0.05,
                f_ac_su=0.02, f_va_aa=0.23, f_bu_aa=0.07, f_pro_aa=0.07, f_ac_aa=0.06,
                f_ac_fa=0.4, f_pro_la=0.03, f_ac_la=0.01, f_ac_et=0.02, f_pro_va=0.54,
                f_ac_va=0.02, f_ac_bu=0.02, f_ac_pro=0.02, f_pro_h2=0.05,
                Y_su=0.07, Y_aa=0.08, Y_fa=0.06, Y_la=0.02, Y_et=0.04, Y_c4=0.06, Y_pro=0.04, Y_ac=0.05, Y_h2=0.06,
                q_dis=0.05, q_ch_hyd=5.0, q_pr_hyd=7.0, q_li_hyd=5.0,
                k_su=30, k_aa=50, k_fa=6, k_la=1.0, k_et=5.0, k_c4=20, k_pro=5.5, k_ac=4.0, k_h2=35,
                K_su=0.5, K_aa=0.3, K_fa=0.4, K_la=0.8, K_et=0.91, K_c4=0.357, K_pro=0.392, K_ac=0.01, K_h2=7e-6,
                b_su=0.02, b_aa=0.02, b_fa=0.02, b_la=0.02, b_et=0.02, b_c4=0.02, b_pro=0.02, b_ac=0.02, b_h2=0.02,
                KI_h2_fa=5e-6, KI_h2_c4=1e-5, KI_h2_pro=3.5e-6, KI_h2_la=3e-4, KI_h2_et=1e-5, KI_nh3=1.8e-3, KS_IN=1e-4,
                KI_la_ac=12, KI_ac=0.01,
                pH_limits_aa=(4,5.5), pH_limits_ac=(6,7), pH_limits_h2=(5,6),
    ...
    def check_stoichiometric_parameters(self):
        ...
        subst = ('xc', 'su', 'aa', 'fa', 'la', 'et', 'va', 'bu', 'pro')
        for s in subst:
            f_tot = sum([stoichio[k] for k in self._stoichio_params[:-9] \
                         if k.endswith(s)])
            if f_tot != 1:
